	...
	function addNewCategory(event){
		...
		let nameValue = document.querySelector('#addCategory input[name=categoryName]').value;
		let colorValue = document.querySelector('#addCategory input[name=categoryColor]').value;
		let foreignIDValue = document.querySelector('#addCategory input[name=foreignID]').value;
		let isUserValue = document.querySelectorAll('#addCategory input[type=radio][name=isUser]:checked')[0].value;
